...
- Usage: `subtitler [video-device] [connector-id] [--output=software|pisp|window|null] [--no-audio]` (defaults: `/dev/video0`, auto connector, software NV16 output, CV105 audio capture on).
